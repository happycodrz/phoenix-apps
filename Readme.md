...
- [WallarooLabs/wallaroo](https://github.com/WallarooLabs/wallaroo) - Build and scale real-time data applications as easily as writing a Python script <br/> ( 2018-07-25 / 4353 commits / 1031 stars )
...
- [coderplanets/coderplanets_server](https://github.com/coderplanets/coderplanets_server) - backend of coderplanets.com <br/> ( 2018-07-28 / 519 commits / 2 stars )
...
- [dailydrip/firestorm](https://github.com/dailydrip/firestorm) - An open-source forum engine, with an Elixir+Phoenix backend and an Elm frontend. <br/> ( 2018-07-13 / 179 commits / 791 stars )
...
- [santiment/sanbase2](https://github.com/santiment/sanbase2) - The source code of the Sanbase application in Santiment LLC <br/> ( 2018-07-27 / 2494 commits / 31 stars )
...
- [ElixirSeattle/tanx](https://github.com/ElixirSeattle/tanx): 2018-07-25  <br/>  Tank game created by the Programming Elixir study group
- [WallarooLabs/wallaroo](https://github.com/WallarooLabs/wallaroo): 2018-07-25  <br/>  Build and scale real-time data applications as easily as writing a Python script
- [dwyl/bestevidence](https://github.com/dwyl/bestevidence): 2018-07-25  <br/>  City, University of London BestEvidence app
- [LittleKidogo/spender](https://github.com/LittleKidogo/spender): 2018-07-24  <br/>  Some automated forms to aid in our spending
- [aviabird/snitch](https://github.com/aviabird/snitch): 2018-07-24  <br/>  E-Commerce re-invented in Elixir
- [fremantle-capital/tai](https://github.com/fremantle-capital/tai): 2018-07-24  <br/>  A trading toolkit built with Elixir that runs on the Erlang virtual machine
- [mozilla/reticulum](https://github.com/mozilla/reticulum): 2018-07-23  <br/>  Phoenix web server for Social MR
- [thoughtbot/constable](https://github.com/thoughtbot/constable): 2018-07-20  <br/>  Better company announcements
- [EdgeCommander/edge-commander](https://github.com/EdgeCommander/edge-commander): 2018-07-20  <br/>  Device Management & Monitoring Application
- [hexpm/hexpm](https://github.com/hexpm/hexpm): 2018-07-19  <br/>  API server and website for Hex
...
- [barsoom/review](https://github.com/barsoom/review): 2018-07-11  <br/>  A tool for commit-by-commit code review of repositories on GitHub
...
- [instedd/ask](https://github.com/instedd/ask): 2018-06-27  <br/>  InSTEDD Ask
- [ironbay/kora](https://github.com/ironbay/kora): 2018-06-27  <br/>  Modern NoSQL + Graph database that facilitates real-time data syncing between online or offline devices and servers. Eliminates the need for API servers between database and client
- [acconrad/peergym](https://github.com/acconrad/peergym): 2018-06-27  <br/>  PeerGym is a health and fitness club directory written in Elixir/Phoenix that provides equipment inventory and more in-depth information than you would find on a traditional review site like Google Reviews or Yelp.
- [cruessler/lafamiglia](https://github.com/cruessler/lafamiglia): 2018-06-26  <br/>  Browser-based strategic multiplayer game
- [johndavedecano/CoderJobs](https://github.com/johndavedecano/CoderJobs): 2018-06-26  <br/>  A job board application built using Elixir and Phoenix Framework.
- [healthlocker/healthlocker](https://github.com/healthlocker/healthlocker): 2018-06-22  <br/>  Inspire and motivate people to stay well.
- [simplabs/breethe-server](https://github.com/simplabs/breethe-server): 2018-06-22  <br/>  Air Quality Data for Locations around the World
- [Prabandham/excms](https://github.com/Prabandham/excms): 2018-06-21  <br/>  This is a tailored CMS application to fit to the needs of Larks.
- [crossfield/cx_leaderboard](https://github.com/crossfield/cx_leaderboard): 2018-06-19  <br/>  Elixir library for fast, customizable leaderboards
- [Ninjarab/hydra](https://github.com/Ninjarab/hydra): 2018-06-17  <br/>  Hydra is a free tool for predicting stock prices using technical analysis
- [thoughtbot/community](https://github.com/thoughtbot/community): 2018-06-15  <br/>  
- [emadb/rovex](https://github.com/emadb/rovex): 2018-06-15  <br/>  A multi mars rover implementation in Elixir.
- [sergiotapia/magnetissimo](https://github.com/sergiotapia/magnetissimo): 2018-06-10  <br/>  Web application that indexes all popular torrent sites, and saves it to the local database.
...
- [digitalnatives/course_planner](https://github.com/digitalnatives/course_planner): 2018-03-24  <br/>  An application to manage educational courses
- [code-corps/code-corps-api](https://github.com/code-corps/code-corps-api): 2018-03-24  <br/>  Elixir/Phoenix API for Code Corps.
- [danbruder/whiteboard](https://github.com/danbruder/whiteboard): 2018-03-21  <br/>  Multi-user real time whiteboard
- [almightycouch/gitgud](https://github.com/almightycouch/gitgud): 2018-03-05  <br/>  GitHub clone entirely written in Elixir.
- [cerclecrm/cercle](https://github.com/cerclecrm/cercle): 2018-01-26  <br/>  Cercle is the ultimate CRM+Project Manager for your organization - Phoenix Framework & Vuejs
- [GBH/loaded.bike](https://github.com/GBH/loaded.bike): 2018-01-07  <br/>  Phoenix/Elixir web app for exploring and sharing bicycle touring routes
- [vutuv/vutuv](https://github.com/vutuv/vutuv): 2017-11-29  <br/>  vutuv is a social network service to host and share information about humans and organizations.
- [mgwidmann/slack_coder](https://github.com/mgwidmann/slack_coder): 2017-11-27  <br/>  Slack Bot for watching your Github & CI builds
- [rizafahmi/elixirjobs](https://github.com/rizafahmi/elixirjobs): 2017-10-22  <br/>  Job portal for Alchemist
- [pcorey/inject_detect](https://github.com/pcorey/inject_detect): 2017-09-26  <br/>  
- [valo/melodica-inventory](https://github.com/valo/melodica-inventory): 2017-08-15  <br/>  The inventory system for biggest Bulgarian wedding agency
- [boilercoding/crm](https://github.com/boilercoding/crm): 2017-07-19  <br/>  Contact Management made with Elixir
- [usecanvas/api-v2](https://github.com/usecanvas/api-v2): 2017-04-04  <br/>  
- [cancoin/bitcoin-voyager](https://github.com/cancoin/bitcoin-voyager): 2016-12-02  <br/>  Websocket and REST Server for querying Libbitcoin Server
- [https://git.pleroma.social/pleroma/pleroma](https://git.pleroma.social/pleroma/pleroma): ---  <br/>  ---
- [https://gitlab.com/code-stats/code-stats](https://gitlab.com/code-stats/code-stats): ---  <br/>  ---
<!-- /ACTIVITY_LIST -->
